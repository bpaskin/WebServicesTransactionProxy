...
public class RemoveWSATHandler implements SOAPHandler<SOAPMessageContext> {
    
    private static final Logger logger = Logger.getLogger(RemoveWSATHandler.class.getName());
